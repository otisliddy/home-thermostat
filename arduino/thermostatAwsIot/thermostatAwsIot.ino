...
const char* MAIN_SHADOW_TOPIC_GET_ACCEPTED = "$aws/things/ht-main/shadow/name/ht-main_shadow/get/accepted";
const char* MAIN_SHADOW_TOPIC_UPDATE = "$aws/things/ht-main/shadow/name/ht-main_shadow/update";
const char* MAIN_SHADOW_TOPIC_UPDATE_DELTA = "$aws/things/ht-main/shadow/name/ht-main_shadow/update/delta";
